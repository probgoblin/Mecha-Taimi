...
public class HelpCommand implements Command {
    private final String helpMessage = "Riz-GW2-Event-Bot Help:\n" +
            "Commands:\n" +
            "**!setEventLeaderRole [role]** - Set the role that serves as an event leader. This is only usable by people with the manage server permission\n" +
            "**!createEvent** - Start the event creation process. Usable by people with the event leader role\n" +
            "**!removeFromEvent [event id] [name]** - Remove a player from an event. Only usable by event leaders\n" +
            ...
            "**!editEvent [event id]** - Start the event edit process. Usable by people with then event leader role\n" +
            "**!help** - You are looking at it\n" +
            "**!info** - Information about the bot and it's author\n" +
            "\n\n" +
            "Help information:\n" +
            "To use this bot, set the event leader role, and then anyone with that role can use !createEvent. This will take them through" +
